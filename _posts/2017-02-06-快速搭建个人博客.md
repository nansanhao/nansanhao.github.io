...
> **搭博客之前必看**：
>
> 以下内容会有一些新的坑，比如`fork`BY的博客并且改名之后，仍然无法打开自己的网站，原因是因为BY的github博客已经绑定了他的域名，将配置找到注释掉即可。
...
本博客转自[BY Blog](http://qiubaiying.top)，希望对你们有用，如果有多余的时间，希望帮**原博**star。

当然这是我的博客：[南三号](https://nansanhao.github.io/)
